// ================================================================
// STUDYHUB – COMPLETE SCRIPT (ALL FEATURES + CANVA + MELODY TIMER)
// ================================================================
...
function playSoftMelody() {
    try {
        ...
        // Gentle pentatonic scale: C5, D5, E5, G5, A5, G5, E5, D5
...
// ================================================================
// TRANSLATION ENGINE (only English key added for Canva – others inherit fallback)
// ================================================================
...
const translations = {
    ...
    // Other languages (es, zh, hi, etc.) will fall back to English for 'canva_desc'.
    // To add translations for other languages, just add 'canva_desc': '...' to those objects.
    es: {},
    zh: {},
    hi: {},
    ar: {},
